...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $examinationQuestion->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $examinationQuestion->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="examinationQuestions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Examination Question') ?></legend>
                <?php
