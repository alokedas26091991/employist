<div class="row column1">
                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>Update Paper <small></small></h2>
                                 </div>
 ...
 <label for="focusedinput" class="col-md-3 label-control" for="projectinput1">
			...
			<div class="col-sm-9">
			<?php 
			            echo $this->Form->control('slug',['class'=>'form-control','empty' => true,'label' => false,'div'=>false]);
			?>
	</div>
	</div>
	<div class="form-group row">		
 ...
 <label for="focusedinput" class="col-md-3 label-control" for="projectinput1">
			...
			<div class="col-sm-9">
			<?php 
			            echo $this->Form->control('show_in_site',['class'=>'form-control','empty' => true,'label' => false,'div'=>false]);
			?>
	</div>
	</div>
 ...
 <label for="focusedinput" class="col-md-3 label-control" for="projectinput1">
			...
			<div class="col-sm-9">
			<?php 
			            echo $this->Form->control('image_file',['type'=>'file','class'=>'form-control','empty' => true,'label' => false,'div'=>false]);
			?>
	</div>
	</div>	
