                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>Update Email <small></small></h2>
                                 </div>
...
<label for="focusedinput" class="col-md-3 label-control" for="projectinput1">
         ...
         echo $this->Form->control('body', ['class'=>'form-control ckeditor','label' => false,'div'=>false]);
...
<?php $this->Html->script(['/admin_template/ckeditor/ckeditor','ckeditor-custom-config'], ['block' => 'scriptBottom']) ?>
