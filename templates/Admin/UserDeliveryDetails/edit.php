...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $userDeliveryDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $userDeliveryDetail->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="userDeliveryDetails form content">
            ...
            <fieldset>
                <legend><?= __('Edit User Delivery Detail') ?></legend>
                <?php
