  ...
  public function delete($id = null)
{
    ...
    $enquiry->is_deleted = $enquiry->is_deleted ? 0 : 1;

    if ($this->Enquiries->save($enquiry)) {
        $statusText = $enquiry->is_deleted ? 'deleted' : 'restored';
        $this->Flash->success(__('The enquiry has been ' . $statusText . '.'));
    } else {
        $this->Flash->error(__('The enquiry could not be updated. Please, try again.'));
    }
